...
# Started 416pm APril20201`7
# year1 <- manysimulations(freq=1, spp=20, sims=10000)
# save(year1, file="~/negative_population_trends/10ksims_freq1_spp20_numyears100.Rdata")
# 
# year2 <- manysimulations(freq=2, spp=20, sims=10000)
# save(year2, file="~/negative_population_trends/10ksims_freq2_spp20_numyears100.Rdata")
# 
# year3 <- manysimulations(freq=5, spp=20, sims=10000)
...
barbar <-rbind(bars1, bars2, bars3)
